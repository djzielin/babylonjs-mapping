    ...
    try {
        ...
        await writeFile(
            ...
            [
                ...
                'const camera = new UniversalCamera("pick", new Vector3(0, 1, -10), scene);',
                'const ray = scene.createPickingRay(10, 10, Matrix.Identity(), camera);',
                'if (!ray || !Number.isFinite(ray.direction.x)) throw new Error("Tile picking was not registered");',

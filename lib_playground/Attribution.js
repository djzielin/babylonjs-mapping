 ...
 class Attribution {
    ...
    addAttributionOSM() {
        this.buttonOSM = BABYLON.GUI.Button.CreateSimpleButton("button_osm", "© OpenStreetMap contributors");
    ...
    addAttributionOSMBuildings() {
        this.buttonOSMBuildings = BABYLON.GUI.Button.CreateSimpleButton("button_osm", "© OSM Buildings");
    ...
    */
    addAttributionMapbox() {
        this.buttonMB = BABYLON.GUI.Button.CreateSimpleButton("button_mb", "© Mapbox");
        ...
        this.buttonImprov = BABYLON.GUI.Button.CreateSimpleButton("button_improve", "Improve this map");
        ...
        this.buttonMBLogo = BABYLON.GUI.Button.CreateImageOnlyButton("button_logo", "https://upload.wikimedia.org/wikipedia/commons/thumb/1/1f/Mapbox_logo_2019.svg/320px-Mapbox_logo_2019.svg.png");

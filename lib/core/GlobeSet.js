...
export default class GlobeSet extends TileSet {
    ...
    constructor(scene, engine, options = {}) {
        super(scene, engine);
        this.isGlobe = true;
        this.edgeFadeTiles = 0;
        this.edgeFadeKeys = new WeakMap();
        this.geometryKeys = new WeakMap();
        this.elevationTileMap = new Map();
        this.tileDirections = new WeakMap();
        this.originalElevations = new WeakMap();
        this.geometryBudgetMs = Infinity;
        this.geometryQueue = [];
        this.polarCapMeshes = [];

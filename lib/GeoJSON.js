...
export class GeoJSON {
    ...
    generateSingleBuilding(shapeType, f, projection, tile, buildingMaterial, exaggeration, defaultBuildingHeight, flipWinding, lineWidth, pointDiameter) {
        let finalMesh = null;
        const arrayOfLines = [];
        ...
        if (f.geometry.type == "Polygon") {
            ...
            if (f.geometry.type == "MultiLineString") {
                ...
                for (let i = 0; i < ps.length; i++) {
                    ...
                    const lineArray = this.convertLinetoArray(cs, projection);
    ...
    convertLinetoArray(cs, projection) {
        const vArray = [];

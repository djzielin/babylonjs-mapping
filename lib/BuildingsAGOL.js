...
export default class BuildingsAGOL extends Buildings {
    ...
    SubmitLoadTileRequest(tile) {
        ...
        const urlOutput = "&outputFormat=GEOJSON";
        const urlFeature = "&typeName=" + this.layerName;
        const urlBox = "&bbox=" + bboxValues.x + "," + bboxValues.y + "," + bboxValues.z + "," + bboxValues.w + ",urn:ogc:def:crs:EPSG:4326";
...
//# sourceMappingURL=BuildingsAGOL.js.map